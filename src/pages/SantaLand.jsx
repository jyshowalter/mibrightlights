            ...
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-xl leading-8 text-info">
                  ...
                  opportunities. Explore a charming gingerbread house, pose with
                  Rudolph, admire the Nutcracker scene, stroll through the
                  Present Tunnel, interact with Santa's Mailbox, visit the
                  Nativity Scene, and much more! Stay cozy by the burn barrels
