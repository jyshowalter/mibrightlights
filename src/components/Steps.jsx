...
const Steps = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center align-center pt-10 pb-16">
      <div className="card bg-base-100 sm:w-80 md:w-96 h-auto lg:h-[30rem] flex flex-col card-bordered border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f] mx-20 mt-12">
        <figure className="px-20 md:px-32 lg:px-20 2xl:px-32 pt-20 flex-shrink-0">
          <img
      ...
      <div className="card bg-base-100 sm:w-80 md:w-96 h-auto lg:h-[30rem] flex flex-col card-bordered border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f] mx-20 mt-12">
        ...
        <div className="card-body text-center flex-grow flex flex-col justify-between">
          ...
          <p className="text-info">
            After you purchase your ticket(s), head to our location. You will
            redeem your ticket(s) at the gate
          </p>
        </div>
      </div>
      <div className="card bg-base-100 sm:w-80 md:w-96 h-auto lg:h-[30rem] flex flex-col card-bordered border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f] mx-20 mt-12">
